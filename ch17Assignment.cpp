...
#include <string>
using namespace std;
// Change a linked list into a doubly linked list and implement a reverse print method
...
class linkedList {
public:
	linkedList() :top(NULL), end(NULL) {} //added end(NULL)***************************************************************
	bool empty() { return top == NULL; }
	node* getTop() { return top; }
	node* getEnd() { return end; }//***************************************************************
	void setTop(node* n) { top = n; if (top != NULL)n->prev = NULL; else end = NULL; }// added if(top != NULL)n->prev = NULL; else end = NULL; //********************************************
	void add(string);
	int menu();
	void remove(string);
	~linkedList();
		...
		if (curr->name == s) {
			...
			if (prev == NULL) {
				...
				if (curr->next == NULL) {
					...
					prev->next = curr->next;			//Original
					curr->next->prev = curr->prev;
					delete(curr);						//Original
				}
			}//***************************************************************
		}
